...
EMSCRIPTEN_BINDINGS(nle_timeline_engine) {
    class_<TimelineEngine>("TimelineEngine")
        ...
        .function("set_clip_opacity",     &TimelineEngine::set_clip_opacity)
        .function("set_clip_position",    &TimelineEngine::set_clip_position)
        .function("set_clip_scale",       &TimelineEngine::set_clip_scale)
        .function("set_clip_anchor",      &TimelineEngine::set_clip_anchor)
        .function("set_clip_blend_mode",  &TimelineEngine::set_clip_blend_mode)
        ...
        .function("set_track_opacity",    &TimelineEngine::set_track_opacity)
        .function("set_track_solo",       &TimelineEngine::set_track_solo)
        .function("resolve_frame",        &TimelineEngine::resolve_frame)
        .function("resolve_all_frames",   &TimelineEngine::resolve_all_frames)
